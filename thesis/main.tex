...
%%     堀田からの申し送りです。中身は guide.tex、PDF はこう作ります。
%%
%%         latexmk guide-only.tex          → guide-only.pdf（10 ページ）
%%
%%     Overleaf なら Menu -> Settings -> Main document を一時的に
%%     guide-only.tex にすれば読めます（読み終わったら main.tex に戻す）。
