...
%% 「面白いから」は理由になりません。「ここが分かっていないから」を書いてください。
...
%% 「標準的な手法を用いた」で済ませないこと。何が標準かは 10 年で変わります。
...
%% 図は必ず本文から \ref{} で参照します。参照されない図は載せる意味がありません。
...
%% 減点ではなく加点です。逆に、審査で指摘されて初めて気づくのが一番まずい。
...
%% 結論は「まとめ」ではありません。
%% 序論で立てた問いに対する答えを、短く言い切る場所です。
%% 新しい図やデータをここで出してはいけません。
